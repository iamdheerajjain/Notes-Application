...
public final class ItemNoteListBinding implements ViewBinding {
  ...
  private ItemNoteListBinding(@NonNull FrameLayout rootView, @NonNull MaterialButton actionBtn,
      @NonNull MaterialCardView cardView, @NonNull TextView dateTxv, @NonNull TextView infoTxv,
      @NonNull LinearLayout itemsLayout, @NonNull ChipGroup labelGroup, @NonNull Chip reminderChip,
      @NonNull ImageView swipeImv, @NonNull TextView titleTxv) {
    this.rootView = rootView;
    this.actionBtn = actionBtn;
    this.cardView = cardView;
    this.dateTxv = dateTxv;
    this.infoTxv = infoTxv;
  ...
  @NonNull
  public static ItemNoteListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemNoteListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_note_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemNoteListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.info_txv;
      TextView infoTxv = ViewBindings.findChildViewById(rootView, id);
      if (infoTxv == null) {
        break missingId;
      }
      ...
      return new ItemNoteListBinding((FrameLayout) rootView, actionBtn, cardView, dateTxv, infoTxv,
          itemsLayout, labelGroup, reminderChip, swipeImv, titleTxv);
    }
