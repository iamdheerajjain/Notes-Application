...
public data class ReminderDialogArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ReminderDialogArgs {
      bundle.setClassLoader(ReminderDialogArgs::class.java.classLoader)
      ...
      return ReminderDialogArgs(__noteIds)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): ReminderDialogArgs {
      val __noteIds : LongArray?
