...
public data class ReminderPostponeDateDialogArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ReminderPostponeDateDialogArgs {
      bundle.setClassLoader(ReminderPostponeDateDialogArgs::class.java.classLoader)
      val __date : Long
      ...
      return ReminderPostponeDateDialogArgs(__date)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        ReminderPostponeDateDialogArgs {
      val __date : Long?
