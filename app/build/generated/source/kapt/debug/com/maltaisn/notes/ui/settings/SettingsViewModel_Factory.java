...
public final class SettingsViewModel_Factory {
  ...
  public SettingsViewModel_Factory(Provider<NotesRepository> notesRepositoryProvider,
  ...
  public static SettingsViewModel_Factory create(Provider<NotesRepository> notesRepositoryProvider,
      Provider<LabelsRepository> labelsRepositoryProvider,
      Provider<PrefsManager> prefsManagerProvider, Provider<JsonManager> jsonManagerProvider,
      Provider<ReminderAlarmManager> reminderAlarmManagerProvider) {
    return new SettingsViewModel_Factory(notesRepositoryProvider, labelsRepositoryProvider, prefsManagerProvider, jsonManagerProvider, reminderAlarmManagerProvider);
  }

  public static SettingsViewModel newInstance(NotesRepository notesRepository,
    ...
    return new SettingsViewModel(notesRepository, labelsRepository, prefsManager, jsonManager, reminderAlarmManager, savedStateHandle);
  }
}
